...
export default function Summary({ agreement, formatter }) {
  ...
  return (
    <div>
      ...
      <DuetParagraph>Lisäsijoitus jakautuu sijoituskohteisiin seuraavasti:</DuetParagraph>
            ...
            <tr>
              <td>
                <DuetButton
                  ...
                  external
                >
                  LähiTapiola Hyvinvointi<DuetSpacer size="xx-small" direction="horizontal"></DuetSpacer>
            ...
            <tr>
              <td>
                <DuetButton
                  ...
                  external
                >
                  LähiTapiola Kasvu<DuetSpacer size="xx-small" direction="horizontal"></DuetSpacer>
                  <DuetIcon name="action-new-window-small" margin="none" size="xx-small"></DuetIcon>
                  <DuetVisuallyHidden>, avautuu uuteen ikkunaan</DuetVisuallyHidden>
                </DuetButton>
              </td>
            ...
            <tr>
              <td>
                <DuetButton
                  ...
                  external
                >
                  LähiTapiola Osinko Suomi<DuetSpacer size="xx-small" direction="horizontal"></DuetSpacer>
                  <DuetIcon name="action-new-window-small" margin="none" size="xx-small"></DuetIcon>
                  <DuetVisuallyHidden>, avautuu uuteen ikkunaan</DuetVisuallyHidden>
                </DuetButton>
              </td>
